...
const Footer = () => {
  ...
  return (
    <footer className="border-t p-5 mt-10 gap-3 border-zinc-800 flex justify-around items-start bottom-0 text-xs">
      <div className="flex flex-col gap-2">
        <p className="text-start flex gap-2">
          {/* <Logo className="w-4 h-4" /> */} SolDex
        </p>
