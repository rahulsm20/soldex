 ...
 * - getSignatures(address: string, cursor?: string | null, limit?: number, before?: number): Fetches signatures for the given Solana address.
 * - getTransactions(address?: string, cursor?: string | null, limit?: number, signaturesToFind?: string[]): Fetches transactions for the given Solana address.
 * - getTransactionsForAddress(address?: string, cursor?: string | null, limit?: number, signaturesToFind?: string[]): Fetches transactions for the given Solana address.
 * /
 */
